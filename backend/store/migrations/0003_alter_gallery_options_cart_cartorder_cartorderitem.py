# Generated by Django 6.0.3 on 2026-08-30 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, max_length=100, null=True)),
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnopqrstuvxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789', blank=True, length=10, max_length=10, null=True, prefix='', unique=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
