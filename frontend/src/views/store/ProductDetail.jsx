        ...
        <main className="mb-4 mt-4">
            ...
            <div className="row gx-lg-5">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                    {/* Details */}
                    <div>
                        <h1 className="fw-bold mb-3">{products.title}</h1>
                        ...
                        <h5 className="mb-3">
                            <s className="text-muted me-2 small align-middle">${products.old_price}</s>
                            <span className="align-middle">${products.price}</span>
                        </h5>
